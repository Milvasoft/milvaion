...
#
# Milvaion Email Worker Docker Build Script
# Builds and pushes the Email Worker Docker image to a registry.
#
# Usage:
#   ./build-email-worker.sh -r milvasoft -t 1.0.0
#   ./build-email-worker.sh -r ghcr.io/milvasoft -t latest --skip-push
#
...
DOCKERFILE="$ROOT_DIR/src/Workers/EmailWorker/Dockerfile"

echo ""
echo -e "${MAGENTA}===============================================================${NC}"
echo -e "${MAGENTA}           Milvaion Email Worker Build Script${NC}"
echo -e "${MAGENTA}===============================================================${NC}"
...
echo "     docker-compose up -d email-worker"
