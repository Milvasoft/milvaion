...
REM ============================================================================
REM Milvaion Scheduler API Build Script
REM Builds and pushes Milvaion Scheduler API Docker image.
REM
REM Usage:
REM   build-api.bat -Registry milvasoft -Tag 1.0.0
REM   build-api.bat -Registry ghcr.io/milvasoft -Tag latest -SkipPush
REM ============================================================================
...
if "%Registry%"=="" (
    ...
    echo.
    echo Usage: build-api.bat -Registry ^<registry^> [-Tag ^<tag^>] [-SkipPush]
    echo.
    echo Example:
    echo   build-api.bat -Registry milvasoft -Tag 1.0.0
    echo.
    pause
    exit /b 1
)
...
set "Dockerfile=%RootDir%\src\Milvaion.Api\Dockerfile"

REM Display configuration
echo.
echo ===============================================================
echo           Milvaion Scheduler API Build Script
echo ===============================================================
...
set "ImageName=%Registry%/milvaion-api:%Tag%"
...
if %SkipPush%==0 (
    ...
    if /i not "%Tag%"=="latest" (
        echo [INFO] Pushing %Registry%/milvaion-api:latest...
