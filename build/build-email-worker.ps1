...
<#
.SYNOPSIS
    Builds and pushes Milvaion Email Worker Docker image.
...
.EXAMPLE
    .\build-email-worker.ps1 -Registry "milvasoft" -Tag "1.0.0"

.EXAMPLE
    .\build-email-worker.ps1 -Registry "ghcr.io/milvasoft" -Tag "latest" -SkipPush
#>
...
$dockerfile = Join-Path $rootDir "src/Workers/EmailWorker/Dockerfile"

Write-Host @"
===============================================================
           Milvaion Email Worker Build Script
===============================================================
  Registry: $Registry
  Tag:      $Tag
...
Write-Host "     docker-compose up -d email-worker" -ForegroundColor Gray
