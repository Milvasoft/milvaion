...
$imageName = "$Registry/milvaion-maintenance:$Tag"
...
if ($Tag -ne "latest") {
    ...
    docker tag $imageName "$Registry/milvaion-maintenance:latest"
...
if (-not $SkipPush) {
    ...
    if ($Tag -ne "latest") {
        Write-Info "Pushing $Registry/milvaion-maintenance:latest..."
