...
public partial class MakeUserTypeOptional : Migration
{
    ...
    /// </remarks>
    protected override void Up(MigrationBuilder migrationBuilder) => migrationBuilder.Sql("""ALTER TABLE "Users" ALTER COLUMN "UserType" SET DEFAULT 2;""");

    /// <inheritdoc />
    protected override void Down(MigrationBuilder migrationBuilder) => migrationBuilder.Sql("""ALTER TABLE "Users" ALTER COLUMN "UserType" DROP DEFAULT;""");
}
